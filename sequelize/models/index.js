...
const modelProductoXTecnologia = require("./proyectoxtecnologia")
...
db[modelProductoXTecnologia(sequelize, Sequelize.DataTypes).name] = modelProductoXTecnologia(sequelize, Sequelize.DataTypes);
